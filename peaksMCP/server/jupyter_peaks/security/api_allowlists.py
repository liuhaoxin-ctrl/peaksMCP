...
GENERIC_METHODS = frozenset({
    ...
    "compute", "load", "where", "fillna", "isnull", "notnull", "interp", "groupby", "resample",
    ...
    "join", "replace", "strip", "lower", "upper", "format", "summary_line", "append",
    ...
    "to_excel", "to_feather", "to_hdf", "to_json", "to_parquet",
    "to_pickle", "to_zarr", "to_numpy", "DataFrame", "Series",
    ...
    "is_file", "is_dir", "stat", "resolve", "relative_to", "as_posix", "joinpath", "with_suffix", "stem",
    ...
    "subplots_adjust", "set_title", "set_xlabel", "set_ylabel", "set_aspect",
    "tick_params",
    ...
    "twiny", "loglog", "semilogx", "semilogy", "suptitle", "supxlabel",
    "supylabel", "clf", "cla",
