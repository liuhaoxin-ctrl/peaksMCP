...
- `prompts/p2_tool_aware.txt` contains the semantic five-tool map and execution checkpoints.
...
P1 measures discovery plus execution without benchmark-provided tool names. P2 controls most
discoverability with a semantic tool map and measures execution. Their paired outcome is diagnostic
evidence, not an escalation sequence.
